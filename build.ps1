<#
	.SYNOPSIS
		Module Build wrapper for SAM.PSADTManagement

	.NOTES
		Change Log:
			1.0.0 - 6/23/2021 (Zachary Shupp)

	.LINK
		https://github.com/zacharyshupp/SAM.PSADTManagement
#>
...
$moduleParams = @{
	ModuleName       = "SAM.PSADTManagement"
	Guid             = "da10d866-0be9-44b2-9a01-a9f83433a727"
	Author           = "Zachary Shupp"
	Description      = "SAM.PSADTManagement is a PowerShell module to interact with PSADT and Plaster to generate a Software Package."
	ProjectUri       = "https://github.com/zacharyshupp/SAM.PSADTManagement"
	LicenseUri       = "https://github.com/zacharyshupp/SAM.PSADTManagement/blob/main/LICENSE.md"
	IconUri          = ""
	Tags             = @('SAM', 'Plaster', 'Templates', 'PSADT')
	FormatsToProcess = @()
}
